...
export async function POST(req: NextRequest) {
  ...
  const acceptUrl = `https://thekungfulegacy.com/api/accept-webhook?name=${encodedName}&email=${encodedEmail}`
  const rejectUrl = `https://thekungfulegacy.com/api/reject-webhook?name=${encodedName}&email=${encodedEmail}`
